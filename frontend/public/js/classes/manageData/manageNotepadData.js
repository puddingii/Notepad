...
class ManageNotepadData {
	 ...
	 */
	async load(email) {
		const response = await fetch("http://localhost:8050/api/notepad/loadAllData", {
			method: "post",
			headers: {
	 ...
	 */
	async getLastId() {
		const response = await fetch("http://localhost:8050/api/notepad/getLastId", {
			headers: {
				"Content-type": "application/json"
			}
		});
	...
	async delete(noteId, email) {
		const response = await fetch("http://localhost:8050/api/notepad/delete", {
			method: "delete",
			headers: {
				"Content-type": "application/json"
			},
	...
	async save(id, email, title, text) {
		const response = await fetch("http://localhost:8050/api/notepad/save", {
			method: "post",
			headers: {
				"Content-type": "application/json"
			},
	...
	async saveAs(email, title, text) {
		const response = await fetch("http://localhost:8050/api/notepad/saveAs", {
			method: "post",
			headers: {
				"Content-type": "application/json"
			},
